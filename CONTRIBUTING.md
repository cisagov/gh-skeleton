...
issue](https://github.com/cisagov/gh-skeleton/issues) in this
...
request](https://github.com/cisagov/gh-skeleton/pulls), you will
...
```console
cd gh-skeleton
pyenv virtualenv <python_version_to_use> gh-skeleton
pyenv local gh-skeleton
